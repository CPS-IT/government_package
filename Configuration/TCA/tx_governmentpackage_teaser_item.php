...
return [
    'ctrl' => [
        ...
        'crdate' => 'crdate',
        'cruser_id' => 'cruser_id',
        'title' => 'LLL:EXT:bootstrap_package/Resources/Private/Language/Backend.xlf:tx_governmentpackage_teaser_item',
        'delete' => 'deleted',
        'versioningWS' => true,
        'origUid' => 't3_origuid',
        'hideTable' => true,
    ...
    'columns' => [
        ...
        'title' => [
            'exclude' => true,
            'label' => 'LLL:EXT:government_package/Resources/Private/Language/Backend.xlf:tx_governmentpackage_teaser_item.title',
            'config' => [
                'type' => 'input',
                'size' => 50,
                'eval' => 'trim,required'
        ...
        'link' => [
            'label' => 'LLL:EXT:government_package/Resources/Private/Language/Backend.xlf:tx_governmentpackage_teaser_item.link',
            'exclude' => true,
            'config' => [
                'type' => 'input',
        ...
        'image' => [
            'label' => 'LLL:EXT:government_package/Resources/Private/Language/Backend.xlf:tx_governmentpackage_teaser_item.image',
