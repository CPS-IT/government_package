...
return [
    'ctrl' => [
        ...
        'crdate' => 'crdate',
        'cruser_id' => 'cruser_id',
        'title' => 'LLL:EXT:bootstrap_package/Resources/Private/Language/Backend.xlf:tx_governmentpackage_link_item',
        'delete' => 'deleted',
        'versioningWS' => true,
        'origUid' => 't3_origuid',
        'hideTable' => true,
    ...
    'columns' => [
        ...
        'l10n_parent' => [
            ...
            'config' => [
                ...
                'foreign_table_where' => 'AND tx_governmentpackage_link_item.pid=###CURRENT_PID### AND tx_governmentpackage_link_item.sys_language_uid IN (-1,0)',
                'default' => 0
            ]
        ],
        'l10n_diffsource' => [
        ...
        'title' => [
            'exclude' => true,
            'label' => 'LLL:EXT:government_package/Resources/Private/Language/Backend.xlf:tx_governmentpackage_link_item.title',
            'config' => [
                'type' => 'input',
                'size' => 50,
                'eval' => 'trim,required'
        ...
        'link' => [
            'label' => 'LLL:EXT:government_package/Resources/Private/Language/Backend.xlf:tx_governmentpackage_link_item.link',
            'exclude' => true,
            'config' => [
                'type' => 'input',
